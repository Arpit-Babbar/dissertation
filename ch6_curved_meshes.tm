...
<\body>
  ...
  Section<nbsp><reference|sec:curved.cons.lw>, the LWFR scheme of
  Chapter<nbsp><reference|ch:lwfr> is extended to curvilinear grids. In
  ...
  Chapter<nbsp><reference|ch:lw.subcell.limiter> is extended to curvilinear
  grids. In Section<nbsp><reference|sec:curved.amr>, the Mortar Element
  Method for treatment of non-conformal interfaces in AMR
  ...
  <math|<value|Oo>=<around*|[|-1,1|]><rsup|d>> in contrast to the previous
  ...
  in terms of the reference coordinates and the delta denotes functions that
  ...
  and denote <math|<vxi><rsub|i><rsup|S>> as the projection of
  <math|<vxi>=<around*|(|\<xi\><rsub|j>|)><rsub|j=1><rsup|d>> to the face
  <math|S=L,R> in the <math|i<rsup|th>> direction (see
  ...
  <\equation>
    <around|(|<tf><rsub|e><rsup|\<delta\>>|)><rsub|i><around|(|<vxi>|)>=<big|sum><rsub|<bq>><around|(|J*<ba><rsup|i>\<cdot\><pf>|)><around|(|<vxi><rsub|<bq>>|)>*\<ell\><rsub|<bq>><around|(|<vxi>|)><label|eq:curved.flux.poly.defn>
  </equation>
  ...
  <\equation>
    <around|(|<tf><rsub|e>\<cdot\><bnr><rsub|S,i>|)><rsup|\<ast\>>=<tf><rsup|\<ast\>><around|(|<uu><rsup|-><rsub|S,i>,<uu><rsup|+><rsub|S,i>,<bnr><rsub|S,i>|)>=<value|half>*<around|[|<around|(|<tf><rsup|\<delta\>>\<cdot\><bnr><rsub|S,i>|)><rsup|+>+<around|(|<tf><rsup|\<delta\>>\<cdot\><bnr><rsub|S,i>|)><rsup|->|]>-<frac|\<lambda\><rsub|S,i>|2>*<around|(|<uu><rsup|+><rsub|S,i>-<uu><rsup|-><rsub|S,i>|)><label|eq:curved.rusanov.flux>
  </equation>
  ...
  quadrature points (Appendix<nbsp><reference|app:equiv.dg.fr>). Once the
  continuous flux approximation is obtained, the FR scheme is given by
  ...
  <\equation>
    <tabular|<tformat|<table|<row|<cell|<dv|<uu><rsub|e,<bp>><rsup|\<delta\>>|t>>|<cell|+<frac|1|J<rsub|e,<bp>>>*\<nabla\><rsub|<vxi>>\<cdot\><tf><rsub|e><rsup|\<delta\>><around|(|<vxi>|)>>>|<row|<cell|>|<cell|+<frac|1|J<rsub|e,<bp>>>*<big|sum><rsub|i=1><rsup|d><around|(|<around|(|<tf><rsub|e>\<cdot\><bnr><rsub|R,i>|)><rsup|\<ast\>>-<tf><rsub|e><rsup|\<delta\>>\<cdot\><bnr><rsub|R,i>|)><around|(|<vxi><rsub|i><rsup|R>|)>*g<rsub|R><rprime|'><around|(|\<xi\><rsub|p<rsub|i>>|)>>>|<row|<cell|>|<cell|-<frac|1|J<rsub|e,<bp>>>*<big|sum><rsub|i=1><rsup|d><around|(|<around|(|<tf><rsub|e>\<cdot\><bnr><rsub|L,i>|)><rsup|\<ast\>>-<tf><rsub|e><rsup|\<delta\>>\<cdot\><bnr><rsub|L,i>|)><around|(|<vxi><rsub|i><rsup|L>|)>*g<rsub|L><rprime|'><around|(|\<xi\><rsub|p<rsub|i>>|)>=<bzero>>>>>><label|eq:curved.fr.update.curvilinear>
  </equation>
  ...
  Cartesian domains<nbsp><cite|Zorio2017|babbar2022>
  (Chapter<nbsp><reference|ch:lwfr>) on the transformed
  ...
  <math|<uu><rsub|t>=-<frac|1|J>*\<nabla\><rsub|<vxi>>\<cdot\><tf>><nbsp><eqref|eq:curved.transformed.conservation.law>
  to swap a temporal derivative with a spatial derivative and retain terms up
  to <math|O<around|(|\<Delta\>t<rsup|N+1>|)>>
  ...
  <math|<tF><rsup|\<delta\>><rsub|e>> to <math|<tF>> using the Approximate
  Lax-Wendroff procedure described in Section<nbsp><reference|sec:curved.alwp>
  to get
  ...
  The <math|<tF><rsup|\<delta\>><rsub|e>> will be, in general, discontinuous
  across the element interfaces. Then, we construct the
  <with|font-shape|italic|continuous time averaged flux approximation> by
  performing a correction along each direction <math|i>, analogous to the
  case of FR<nbsp><eqref|eq:curved.cts.num.flux>, leading to
  ...
  averaged numerical flux and does not add any significant computational cost
  ...
  <\equation*>
    <tabular*|<tformat|<cwith|2|2|3|3|cell-halign|l>|<cwith|3|3|3|3|cell-halign|l>|<cwith|1|1|1|1|cell-halign|r>|<table|<row|<cell|<big|int><rsub|<Oo>>\<partial\><rsub|\<xi\><rsup|i>>*<tF><rsup|\<delta\>><rsub|e><around|(|<vxi>|)>*<ud><vxi>>|<cell|=>|<cell|<big|int><rsub|\<partial\>*\<Omega\><rsub|o,i><rsup|L>><around|[|<tF><rsup|\<delta\>><rsub|e>\<cdot\><bnr><rsub|L,i>|]>*<ud>S<rsub|<vxi>>+<big|int><rsub|\<partial\>*\<Omega\><rsub|o,i><rsup|R>><around|[|<tF><rsup|\<delta\>><rsub|e>\<cdot\><bnr><rsub|R,i>|]>*<ud>S<rsub|<vxi>>>>|<row|<cell|<big|int><rsub|<Oo>><around|(|<around|(|<tF><rsub|e>\<cdot\><bnr><rsub|R,i>|)><rsup|\<ast\>>-<tF><rsup|\<delta\>><rsub|e>\<cdot\><bnr><rsub|R,i>|)><around|(|<vxi><rsub|i><rsup|R>|)>*g<rsub|R><rprime|'><around|(|\<xi\><rsub|p<rsub|i>>|)>*<ud><vxi>>|<cell|=>|<cell|<big|int><rsub|\<partial\>*\<Omega\><rsub|o,i><rsup|R>><around|[|<around|(|<tF><rsub|e>\<cdot\><bnr><rsub|R,i>|)><rsup|\<ast\>>-<tF><rsup|\<delta\>><rsub|e>\<cdot\><bnr><rsub|R,i>|]>*<ud>S<rsub|<vxi>>>>|<row|<cell|<big|int><rsub|<Oo>><around|(|<around|(|<tF><rsub|e>\<cdot\><bnr><rsub|L,i>|)><rsup|\<ast\>>-<tF><rsup|\<delta\>><rsub|e>\<cdot\><bnr><rsub|L,i>|)><around|(|<vxi><rsub|i><rsup|L>|)>*g<rsub|L><rprime|'><around|(|\<xi\><rsub|p<rsub|i>>|)>*<ud><vxi>>|<cell|=>|<cell|-<big|int><rsub|\<partial\>*\<Omega\><rsub|o,i><rsup|L>><around|[|<around|(|<tF><rsub|e>\<cdot\><bnr><rsub|L,i>|)><rsup|\<ast\>>-<tF><rsup|\<delta\>><rsub|e>\<cdot\><bnr><rsub|L,i>|]>*<ud>S<rsub|<vxi>>>>>>>
  </equation*>
  ...
  local to each element. The time index is also suppressed as all quantities
  ...
  If the solution of the conservation law<nbsp><eqref|eq:curved.con.law> is
  spatially constant at a time level, then its evolution at later time levels
  remains constant<\footnote>
    This assumes that boundary conditions are either specified by the same
    constant, or are periodic.
  </footnote>. This is the free stream property and it is crucial for the
  numerical scheme to satisfy it in order to avoid very large
  errors<nbsp><cite|Kopriva2006>. In this section, we discuss the conditions
  under which the LWFR scheme is free stream preserving.

  The free stream preservation of a conservation law is equivalent to the
  metric identity<nbsp><eqref|eq:curved.metric.identity.contravariant>. The
  divergence in a Flux Reconstruction (FR)
  ...
  identity><nbsp><eqref|eq:curved.metric.identity.contravariant> is at least
  required for our scheme to preserve a constant state
  ...
  are actually enough to ensure free stream preservation for LWFR. Throughout
  this section, we assume that the mesh is
  <with|font-shape|italic|well-constructed><nbsp><cite|Kopriva2006> which is
  a property that follows from the natural assumption of global continuity of
  the reference map.
  ...
  <subsection|Low order scheme for curvilinear
  grids><label|sec:low.order.curvilinear>
  ...
  Next, perform one point quadrature in the first term and apply the Gauss
  ...
  <\equation>
    <label|eq:curved.lower.order.flux.curved><big|int><rsub|\<partial\>*C><tf>\<cdot\><bnr><ud>A=<big|sum><rsub|i=1><rsup|d><frac|w<rsub|<bp>>|w<rsub|p<rsub|i>>>*<around|[|<around|(|<tf><rsup|\<delta\>><rsub|C>\<cdot\><bnr><rsub|R,i>|)><rsup|\<ast\>><around|(|<vxi><rsub|i><rsup|R>|)>+<around|(|<tf><rsup|\<delta\>><rsub|C>\<cdot\><bnr><rsub|L,i>|)><rsup|\<ast\>><around|(|<vxi><rsub|i><rsup|L>|)>|]>,<space|1em><bnr><rsub|R,i>=<be><rsub|i>,<space|1em><bnr><rsub|L,i>=-<be><rsub|i>
  </equation>
  ...
  the orthonormal Legendre basis and analyze the decay of its coefficients.
  In this section, we write the smoothness indicator for <math|d> dimensions,
  ...
  <\equation*>
    q<rsub|h><around|(|<vxi>|)>=<big|sum><rsub|<bp>><wide|q|^><rsub|<bp>>*L<rsub|<bp>><around|(|<vxi>|)>,<space|1em><vxi>\<in\><Oo>,<space|2em><wide|q|^><rsub|<bp>>=<big|int><rsub|<Oo>>q<around|(|<uu><rsup|\<delta\>><around|(|<vxi>|)>|)>*L<rsub|<bp>><around|(|<vxi>|)>*<ud><vxi>
  </equation*>
  ...
  which measures the \Penergy\Q in <math|q<rsub|h>>. Then the energy
  contained in the highest modes relative to the total energy of the
  ...
  In 1-D, this simplifies into the expression
  ...
  preservation from Chapter<nbsp><reference|ch:lw.subcell.limiter> for 1-D
  and then do a natural extension to curvilinear meshes. The first step in
  obtaining an admissibility preserving blending scheme is to ensure that the
  lower order scheme preserves the admissibility set <math|<Uad>>. This is
  always true if all the fluxes in the lower order method are computed with
  an admissibility preserving low order finite volume method. But the LWFR
  scheme uses a time average numerical flux and maintaining conservation
  requires that we use the same numerical flux at the element interfaces for
  both lower and higher order schemes (Remark<nbsp>1
  of<nbsp><cite|babbar2023admissibility>). To maintain accuracy and
  admissibility, we carefully choose a blended numerical flux
  <math|<F><rsub|<eph>>> as in<nbsp><eqref|eq:Fblend> but this choice may not
  ensure admissibility and further limitation is required. Our proposed
  procedure for choosing the blended numerical flux will give us an
  ...
  Once the low order scheme on subcells is constructed as in
  Section<nbsp><reference|sec:low.order.curvilinear>, the blending scheme
  with smoothness coefficient can be written
  as<nbsp><eqref|eq:blended.scheme>. The theoretical basis for flux limiting
  summarized in Theorem<nbsp><reference|thm:lwfr.admissibility> also applies.
  For clarity, we rewrite Theorem<nbsp><reference|thm:lwfr.admissibility> in
  the notation of general curvilinear specialized to first order blending in
  ...
  For simplicity, we only consider the case where the admissibility
  constraints <math|<value|ad><rsub|k>><nbsp><eqref|eq:uad.form> are concave
  functions of the conservative variables.
      ...
      <\wide-tabular>
        <tformat|<cwith|1|1|1|1|cell-tborder|1ln>|<cwith|1|1|1|1|cell-bborder|1ln>|<cwith|1|1|1|1|cell-lborder|0ln>|<cwith|1|1|1|1|cell-rborder|0ln>|<table|<row|<\cell>
          <\algorithm>
            ...
            <math|<F><rsub|<eph>><rsup|LW>,<pf><rsub|<eph>>,<pf><rsup|e+1><rsub|<value|half>>,<pf><rsup|e><rsub|<value|Nmh>>,<uepoz><rsup|n>,<ueN><rsup|n>,\<alpha\><rsub|e>,\<alpha\><rsub|e+1>><next-line><with|font-series|bold|Output:>
            <math|<F><rsub|<eph>>>
          </algorithm>
        </cell>>>>
      </wide-tabular>
        ...
        <tformat|<table|<row|<\cell>
          ...
          <\wide-tabular>
            <tformat|<table|<row|<\cell>
              ...
              <math|<atu><rsub|0><rsup|n+1>\<leftarrow\><uepoz><rsup|n>-<frac|\<Delta\>t|w<rsub|0>*\<Delta\>x<rsub|e+1>>*<around|(|<pf><rsup|e><rsub|<value|half>>-<F><rsub|<eph>>|)>>
            </cell>>|<row|<\cell>
              <algo-state|<math|<atu><rsub|N><rsup|n+1>\<leftarrow\><ueN><rsup|n>-<frac|\<Delta\>t|w<rsub|N>*\<Delta\>x<rsub|e>>*<around|(|<F><rsub|<eph>>-<pf><rsup|e><rsub|<value|Nmh>>|)>>>
            </cell>>>>
          </wide-tabular>
          ...
          <\wide-tabular>
            <tformat|<table|<row|<\cell>
              <math|\<vartriangleright\>><space|0.2spc>FV inner updates with
              <math|<pf><rsub|<eph>>> which are admissibile
            </cell>>|<row|<\cell>
              <math|<utilow><rsub|0>=<uepoz><rsup|n>-<frac|\<Delta\>t|w<rsub|0>*\<Delta\>x<rsub|e+1>>*<around|(|<pf><rsup|e+1><rsub|<value|half>>-<pf><rsub|<eph>>|)>>
            </cell>>|<row|<\cell>
              <algo-state|<math|<utilow><rsub|N>=<ueN><rsup|n>-<frac|\<Delta\>t|w<rsub|N>*\<Delta\>x<rsub|e>>*<around|(|<pf><rsub|<eph>>-<pf><rsup|e><rsub|<value|Nmh>>|)>>>
            </cell>>>>
          </wide-tabular>
          ...
          <algo-state|<math|<atu><rsub|0><rsup|n+1>\<leftarrow\><uepoz><rsup|n>-<frac|\<Delta\>t|w<rsub|0>*\<Delta\>x<rsub|e+1>>*<around|(|<pf><rsup|e><rsub|<value|half>>-<F><rsub|<eph>>|)>>>
  ...
  of equal <math|k<rsub|i>>'s motivated by the experience of
  Chapter<nbsp><reference|ch:lw.subcell.limiter>, where it was found that
  even this choice does not impose any additional time step constraints over
  the Fourier stability limit. After choosing <math|k<rsub|i>>'s, we have
  reduced the update to 1-D and can repeat the same procedure as in
  ...
  After the flux limiting is performed following
  ...
  <\equation*>
    <value|qqint><rsub|<space|-0.03in>I>u<around|(|\<xi\>|)>*<ud>\<xi\>=<big|sum><rsub|p<subindex>0><rsup|N>u<around|(|\<xi\><rsub|p>|)>*w<rsub|p>,<space|2em><value|qqint><rsub|<space|-0.03in>I<rsub|s>>u<around|(|\<xi\>|)>*<ud>\<xi\>=<big|sum><rsub|p<subindex>0><rsup|N>2*u<around|(|<sphi><rsub|s><rsup|-1><around|(|\<xi\><rsub|p>|)>|)>*w<rsub|p>
  </equation*>
  ...
  <\equation*>
    <value|qqint><rsub|<space|-0.03in>I><proP><rsup|s><around|(|u|)><around|(|\<xi\>|)>*\<ell\><rsub|i><around|(|\<xi\>|)>*<ud>\<xi\>=<value|qqint><rsub|<space|-0.03in>I<rsub|s>>u<around|(|\<xi\>|)>*\<ell\><rsub|i><around|(|\<xi\>|)>*<ud>\<xi\>,<space|2em>0\<leq\>i\<leq\>N
  </equation*>
  ...
  are stored as matrices for the reference element at the beginning of the
  ...
  <math|\<Omega\><rsub|e<rsub|<bss>>>> and <math|\<Omega\><rsub|e>> in
  reference coordinates<\footnote>
    That is, <math|\<Theta\><rsub|e> <sphi><rsub|<bss>>
    \<Theta\><rsub|e><rsup|-1>> is a bijection from
    <math|\<Omega\><rsub|e<rsub|<bss>>>> to <math|\<Omega\><rsub|e>>.
  </footnote>. Recall that <math|<around*|{|\<ell\><rsub|<bp>>|}><rsub|<bp>\<in\><Nnd>>>
  are Lagrange polynomials of degree <math|N> with variables
  ...
  <\equation>
    <big|sum><rsub|<bss>\<in\><Nod>><value|qqint><rsub|<space|-0.03in>\<Omega\><rsub|e<rsub|<bss>>>><uu><rsub|e<rsub|<bss>>>\<ell\><rsub|<bp>><around|(|<vxi>|)><ud><bx>=<value|qqint><rsub|<space|-0.03in>\<Omega\><rsub|e>><uu><rsub|e>\<ell\><rsub|<bp>><around|(|<vxi>|)><ud><bx>,<space|2em>\<forall\><bp>\<in\><Nnd><label|eq:curved.4to1proj>
  </equation>
  ...
  <\equation>
    <big|sum><rsub|<bss>\<in\><Nod>><big|sum><rsub|<bq>\<in\><Nnd>><value|qqint><rsub|<space|-0.03in>\<Omega\><rsub|e<rsub|<bss>>>>\<ell\><rsub|<bp>><around|(|<vxi>|)>*\<ell\><rsub|<bq>><around|(|<sphi><rsub|<bss>><around|(|<vxi>|)>|)><uu><rsub|e<rsub|<bss>>,<bq>><ud><bx>=<big|sum><rsub|<bq>\<in\><Nnd>><value|qqint><rsub|<space|-0.03in>\<Omega\><rsub|e>>\<ell\><rsub|<bp>><around|(|<vxi>|)>*\<ell\><rsub|<bq>><around|(|<vxi>|)><uu><rsub|e,<bq>><ud><bx><label|eq:curved.pro4.with.lagrange>
  </equation>

  Note the 1-D identities

  <\align*>
    <tformat|<table|<row|<cell|<value|qqint><rsub|<space|-0.03in>I>\<ell\><rsub|p><around|(|\<xi\>|)>*\<ell\><rsub|q><around|(|\<xi\>|)><ud>\<xi\>>|<cell|=\<delta\><rsub|p\<nocomma\>q>*w<rsub|p>>>|<row|<cell|<value|qqint><rsub|<space|-0.03in>I<rsub|s>>\<ell\><rsub|p><around|(|\<xi\>|)>*\<ell\><rsub|q><around|(|<sphi><rsub|s><around|(|\<xi\>|)>|)><ud>\<xi\>>|<cell|=<frac|1|2><value|qqint><rsub|<space|-0.03in>-1><rsup|+1>\<ell\><rsub|p><around|(|<sphi><rsub|s><rsup|-1><around|(|\<xi\>|)>|)>*\<ell\><rsub|q><around|(|\<xi\>|)><ud>\<xi\>=<frac|1|2>*\<ell\><rsub|p><around|(|<sphi><rsub|s><rsup|-1><around|(|\<xi\><rsub|q>|)>|)>*w<rsub|q>=\<cal-P\><rsup|s><rsub|p\<nocomma\>q>*w<rsub|p>>>>>
  </align*>
  ...
  <\equation>
    <value|qqint><rsub|<space|-0.03in>\<Omega\><rsub|e>>\<ell\><rsub|<bp>><around|(|<vxi>|)>*\<ell\><rsub|<bq>><around|(|<vxi>|)>=J<rsub|e,<bp>>*<big|prod><rsub|i=1><rsup|d>w<rsub|p<rsub|i>>*\<delta\><rsub|p<rsub|i>\<nocomma\>q<rsub|i>>,<space|2em><value|qqint><rsub|<space|-0.03in>\<Omega\><rsub|e<rsub|<bss>>>>\<ell\><rsub|<bp>><around|(|<vxi>|)>*\<ell\><rsub|<bq>><around|(|<sphi><rsub|<bss>><around|(|<vxi>|)>|)>=J<rsub|e,<bp>>*<big|prod><rsub|i=1><rsup|d>w<rsub|p<rsub|i>>*\<cal-P\><rsup|s<rsub|i>><rsub|p<rsub|i>\<nocomma\>q<rsub|i>><label|eq:curved.integral.identities>
  </equation>
  ...
  that the refinement levels of those elements only differ by
  ...
  <\equation>
    <big|sum><rsub|<bss>\<in\>\<bbb-N\><rsub|1><rsup|d-1>><value|qqint><rsub|<space|-0.03in><G><rsub|<bss>>><F><rsub|<X><rsub|<bss>>><rsup|\<ast\>>*\<ell\><rsub|<bp>>=<value|qqint><rsub|<space|-0.03in><G>><F><rsub|<G>><rsup|\<ast\>>\<ell\><rsub|<bp>>,<space|2em>\<forall\><bp>\<in\>\<bbb-N\><rsub|N><rsup|d-1><label|eq:curved.proj.mortar.int.id>
  </equation>
  ...
  <\equation>
    <big|sum><rsub|<bss>\<in\>\<bbb-N\><rsub|1><rsup|d-1>><big|sum><rsub|<bq>\<in\>\<bbb-N\><rsub|N><rsup|d-1>><value|qqint><rsub|<space|-0.03in><G><rsub|<bss>>>\<ell\><rsub|<bp>><around|(|<bet>|)>*\<ell\><rsub|<bq>><around|(|<sphi><rsub|<bss>><around|(|<bet>|)>|)><F><rsub|<X><rsub|<bss>>,<bq>><rsup|\<ast\>>=<big|sum><rsub|<bq>\<in\>\<bbb-N\><rsub|<bp>><rsup|d-1>><value|qqint><rsub|<space|-0.03in><G>>\<ell\><rsub|<bp>><around|(|<bet>|)>*\<ell\><rsub|<bq>><around|(|<bet>|)><F><rsup|\<ast\>><rsub|<G>,<bq>>,<space|1em>\<forall\><bp>\<in\>\<bbb-N\><rsub|N><rsup|d-1><label|eq:curved.projection.integral.equation>
  </equation>
  ...
  <\equation*>
    <big|sum><rsub|<bss>\<in\>\<bbb-N\><rsub|1><rsup|d-1>><value|qqint><rsub|<space|-0.03in><G><rsub|<bss>>><F><rsub|<X><rsub|<bss>>><rsup|\<ast\>>*v=<value|qqint><rsub|<space|-0.03in><G>><F><rsub|<G>><rsup|\<ast\>>*v,<space|2em>v\<in\><polyP><rsub|N>
  </equation*>
  ...
  <\remark>
    ...
    <\enumerate>
      ...
      admissibility of solution at any desired points, the remedy to both
  ...
  <math|f<rsub|wave>=0.2> has been chosen in all the
  tests<nbsp><cite|lohner1987>.
  ...
  Reconstruction method. First, recall that a standard way to compute the
  time step size <math|\<Delta\>t<rsup|n>> is to follow
  Chapter<nbsp><reference|ch:lwfr> and use
  ...
  <math|C<rsub|s>\<leq\>1> is a safety factor. In
  Section<nbsp><reference|sec:four1d>, a Fourier stability analysis of the
  LWFR scheme was performed on Cartesian grids, and the optimal <math|CFL>
  numbers were obtained for each degree <math|N>
  (Table<nbsp><reference|tab:cfl>) which guaranteed the stability of the
  scheme. However, the Fourier stability analysis does not apply to
  curvilinear grids and formula<nbsp><eqref|eq:curved.cfl.formula> need not
  guarantee <math|L<rsup|2>> stability with CFL numbers from
  Table<nbsp><reference|tab:cfl>. Thus, formula<nbsp><eqref|eq:curved.cfl.formula>
  may require the CFL number to be fine-tuned for each problem. Along with
  the <math|L<rsup|2>> stability, the time step has to be chosen so that the
  scheme does not give inadmissible solutions. An error-based time stepping
  method inherently minimizes the parameter tuning process in time step
  computation. The parameters in an error-based time stepping scheme that a
  user has to specify are the absolute and relative error tolerances
  <math|\<tau\><rsub|a>,\<tau\><rsub|r>>, and they only affect the time step
  size logarithmically. In particular, because of the weak dependence,
  tolerances <math|\<tau\><rsub|a>=\<tau\><rsub|r>=10<rsup|-6>> worked
  reasonably for all tests with shocks; although, it was possible to enhance
  performance by choosing larger tolerances for some problems. Secondly, if
  inadmissibility is detected during any step in the scheme or if errors are
  too large, the time step is redone with a reduced time step size provided
  by the error estimate. The scheme also has the capability of increasing and
  ...
  conservative variables. The tolerances are to be chosen by the user but
  ...
  is used to prevent sudden increases in time step sizes. For normalization,
    ...
    <tformat|<cwith|2|2|1|1|cell-tborder|0ln>|<cwith|1|1|1|1|cell-bborder|0ln>|<cwith|2|2|1|1|cell-bborder|1ln>|<cwith|2|2|1|1|cell-lborder|0ln>|<cwith|2|2|1|1|cell-rborder|0ln>|<cwith|2|2|1|1|cell-halign|c>|<table|<row|<\cell>
      ...
      <\wide-tabular>
        <tformat|<table|<row|<\cell>
          ...
          <math|<value|tF><rsup|\<delta\>><rsub|e>> as
          ...
          <math|<value|tF><rsup|\<delta\>><rsub|e>> to the
  ...
  <\wide-tabular>
    <tformat|<cwith|2|2|1|1|cell-tborder|0ln>|<cwith|1|1|1|1|cell-bborder|0ln>|<cwith|2|2|1|1|cell-bborder|1ln>|<cwith|2|2|1|1|cell-lborder|0ln>|<cwith|2|2|1|1|cell-rborder|0ln>|<cwith|2|2|1|1|cell-halign|c>|<table|<row|<\cell>
      <\wide-tabular>
        <tformat|<cwith|1|1|1|1|cell-tborder|1ln>|<cwith|1|1|1|1|cell-bborder|1ln>|<cwith|1|1|1|1|cell-lborder|0ln>|<cwith|1|1|1|1|cell-rborder|0ln>|<table|<row|<\cell>
          <\algorithm>
            High level overview of LWFR residual (Within time
            integration)<label|alg:lw.residual>
          </algorithm>
        </cell>>>>
      </wide-tabular>
    </cell>>|<row|<\cell>
    ...
    <tformat|<cwith|2|2|1|1|cell-tborder|0ln>|<cwith|1|1|1|1|cell-bborder|0ln>|<cwith|2|2|1|1|cell-bborder|1ln>|<cwith|2|2|1|1|cell-lborder|0ln>|<cwith|2|2|1|1|cell-rborder|0ln>|<cwith|2|2|1|1|cell-halign|c>|<table|<row|<\cell>
      ...
      <\wide-tabular>
        <tformat|<cwith|2|2|1|1|cell-halign|l>|<table|<row|<\cell>
          ...
          ><space|7em><math|\<vartriangleright\>><space|0.2spc><math|M> is
          the total number of dofs>>|<row|<cell|<algo-state|<math|w<rsub|n+1>\<leftarrow\>max
          <around|{|w<rsub|n+1>,10<rsup|-10>|}>>><space|1.6spc><space|13em><space|1em><math|\<vartriangleright\>><space|0.2spc>To
          ...
          <math|\<leftarrow\>> <math|\<kappa\>*<around|(|\<varepsilon\><rsub|n+1><rsup|\<beta\><rsub|1>/k>*\<varepsilon\><rsub|n><rsup|\<beta\><rsub|2>/k>*\<varepsilon\><rsub|n-1><rsup|\<beta\><rsub|3>/k>|)>>><space|2.4spc><space|12em><math|\<vartriangleright\>><space|0.2spc><math|\<kappa\><around|(|x|)>=1+tan<rsup|-1><around|(|x-1|)>>>>|<row|<cell|<algo-state|<math|<wide|\<Delta\>t|~>\<leftarrow\>><verbatim|dt_factor><math|\<cdot\>\<Delta\>t<rsub|n>>>>>|<row|<cell|<with|font-series|bold|if>
          ...
          <space|2.0spc><space|10em><math|\<vartriangleright\>><space|0.2spc>Analyze
          and postprocess solution, AMR>>|<row|<cell|<algo-state|Positivity
          correction for AMR (Remark<nbsp><reference|rmk:amr.metric.terms>)>>>>>>>>|<row|<cell|<with|font-series|bold|end
          if>>>>>>
  ...
  numerical tests, which is the typical value for air. A comparison will be
  made between error and CFL based time stepping schemes where the CFL based
  time stepping schemes use the following formula for the time step (see
  (2.5) of<nbsp><cite|ranocha2023>, but also<nbsp><cite|Rasha2021|Ranocha2021>)
  ...
  for <math|<around|{|J*<ba><rsup|i>|}><rsub|i<subindex>1><rsup|d>> being the
  contravariant vectors<nbsp><eqref|defn:curved.contravariant.basis> and
  <math|\<lambda\><rsub|e,<bp>><rsup|i>> the absolute maximum eigenvalue of
  <math|<pf><rprime|'><rsub|i><around|(|<uu><rsub|e,<bp>>|)>>. For Euler's
  ...
  <math|<Cs>><nbsp><eqref|eq:curved.cfl.effective> is plotted up to
  ...
  problem-dependent and require smart user intervention.
  ...
  stem do not appear. The simulation starts with a mesh of 198 elements and
  ...
  of a strong shock and thus the positivity limiter had to be used to enforce
  admissibility. The flow behind the cylinder is highly unsteady, with
  reflected shocks and vortices interacting continuously. The density profile
  of the numerical solution at <math|t=10> is shown in
  ...
  are taken to be the same, and denoted <verbatim|tolE>. The iterations that
  ...
  process, an embedded error-based time step computation method was
...
<\references>
  <\collection>
    <associate|alg:blended.flux|<tuple|8.1|166>>
    <associate|alg:cell.residual|<tuple|8.2|178>>
    <associate|alg:lw.residual|<tuple|8.3|178>>
    <associate|alg:time.stepping|<tuple|8.4|179>>
    <associate|auto-1|<tuple|8|151>>
    <associate|auto-10|<tuple|8.4|161>>
    <associate|auto-11|<tuple|8.4.1|161>>
    <associate|auto-12|<tuple|8.2|161>>
    <associate|auto-13|<tuple|8.4.2|164>>
    <associate|auto-14|<tuple|8.4.3|165>>
    <associate|auto-15|<tuple|8.4.3.1|165>>
    <associate|auto-16|<tuple|8.4.3.2|166>>
    <associate|auto-17|<tuple|8.5|167>>
    <associate|auto-18|<tuple|8.5.1|169>>
    <associate|auto-19|<tuple|8.3|169>>
    <associate|auto-2|<tuple|8.1|151>>
    <associate|auto-20|<tuple|8.5.1.1|169>>
    <associate|auto-21|<tuple|8.5.1.2|170>>
    <associate|auto-22|<tuple|8.5.2|171>>
    <associate|auto-23|<tuple|8.5.2.1|171>>
    <associate|auto-24|<tuple|8.4|171>>
    <associate|auto-25|<tuple|8.5.2.2|172>>
    <associate|auto-26|<tuple|8.5.2.3|173>>
    <associate|auto-27|<tuple|8.5.3|175>>
    <associate|auto-28|<tuple|8.6|176>>
    <associate|auto-29|<tuple|8.6.1|176>>
    <associate|auto-3|<tuple|8.2|151>>
    <associate|auto-30|<tuple|8.6.2|177>>
    <associate|auto-31|<tuple|8.7|179>>
    <associate|auto-32|<tuple|8.7.1|180>>
    <associate|auto-33|<tuple|8.7.1.1|180>>
    <associate|auto-34|<tuple|8.5|181>>
    <associate|auto-35|<tuple|8.7.1.2|181>>
    <associate|auto-36|<tuple|8.6|182>>
    <associate|auto-37|<tuple|8.7.1.3|182>>
    <associate|auto-38|<tuple|8.7|183>>
    <associate|auto-39|<tuple|8.7.1.4|183>>
    <associate|auto-4|<tuple|8.3|154>>
    <associate|auto-40|<tuple|8.8|184>>
    <associate|auto-41|<tuple|8.7.2|184>>
    <associate|auto-42|<tuple|8.7.2.1|184>>
    <associate|auto-43|<tuple|8.9|185>>
    <associate|auto-44|<tuple|8.7.2.2|185>>
    <associate|auto-45|<tuple|8.10|186>>
    <associate|auto-46|<tuple|8.7.2.3|186>>
    <associate|auto-47|<tuple|8.11|187>>
    <associate|auto-48|<tuple|8.7.2.4|188>>
    <associate|auto-49|<tuple|8.12|188>>
    <associate|auto-5|<tuple|8.3.1|154>>
    <associate|auto-50|<tuple|8.7.2.5|188>>
    <associate|auto-51|<tuple|8.13|189>>
    <associate|auto-52|<tuple|8.14|189>>
    <associate|auto-53|<tuple|8.7.3|190>>
    <associate|auto-54|<tuple|8.1|190>>
    <associate|auto-55|<tuple|8.8|191>>
    <associate|auto-6|<tuple|8.1|154>>
    <associate|auto-7|<tuple|8.3.2|156>>
    <associate|auto-8|<tuple|8.3.3|158>>
    <associate|auto-9|<tuple|8.3.4|158>>
    <associate|ch:curved.meshes|<tuple|8|151>>
    <associate|defn.mean|<tuple|8.30|157>>
    <associate|defn:curved.contravariant.basis|<tuple|8.2|153>>
    <associate|defn:curved.covariant.basis|<tuple|8.1|152>>
    <associate|defn:curved.well.constructed.mesh|<tuple|8.4|159>>
    <associate|eq:curved.2d.adm.numflux.desired|<tuple|8.53|167>>
    <associate|eq:curved.2d.low.update.admissibility.condn|<tuple|8.52|167>>
    <associate|eq:curved.2d.xy.implies.admissibility|<tuple|8.54|167>>
    <associate|eq:curved.4to1proj|<tuple|8.62|170>>
    <associate|eq:curved.Fdelta.low|<tuple|8.76|177>>
    <associate|eq:curved.Fisf|<tuple|8.41|160>>
    <associate|eq:curved.I0.defn|<tuple|8.55|168>>
    <associate|eq:curved.Nnd|<tuple|8.5|152>>
    <associate|eq:curved.Uisu|<tuple|8.42|160>>
    <associate|eq:curved.approx.soln|<tuple|8.15|154>>
    <associate|eq:curved.blended.flux.in.curved|<tuple|8.48|163>>
    <associate|eq:curved.cfl.effective|<tuple|8.79|181>>
    <associate|eq:curved.cfl.formula|<tuple|8.72|176>>
    <associate|eq:curved.cfl.time.step|<tuple|8.78|180>>
    <associate|eq:curved.compact.prolongation|<tuple|8.67|173>>
    <associate|eq:curved.con.law|<tuple|8.1|151>>
    <associate|eq:curved.conservation.lw|<tuple|8.29|157>>
    <associate|eq:curved.contravariant.flux.defn|<tuple|8.13|153>>
    <associate|eq:curved.contravariant.identity|<tuple|8.9|153>>
    <associate|eq:curved.cts.num.flux|<tuple|8.18|155>>
    <associate|eq:curved.cts.time.avg.flux|<tuple|8.25|156>>
    <associate|eq:curved.defn1.div|<tuple|8.2|152>>
    <associate|eq:curved.divergence.transform.contravariant|<tuple|8.10|153>>
    <associate|eq:curved.dtnp1.formula|<tuple|8.73|177>>
    <associate|eq:curved.error.estimator|<tuple|8.74|177>>
    <associate|eq:curved.final.int.identity.fxi|<tuple|8.66|172>>
    <associate|eq:curved.flux.poly.defn|<tuple|8.17|154>>
    <associate|eq:curved.fo.rusanov|<tuple|8.47|162>>
    <associate|eq:curved.fr.update.curvilinear|<tuple|8.22|155>>
    <associate|eq:curved.ft.defn|<tuple|8.32|158>>
    <associate|eq:curved.gradient.transform.contravariant|<tuple|8.11|153>>
    <associate|eq:curved.integral.identities|<tuple|8.64|170>>
    <associate|eq:curved.interpolation.defn|<tuple|8.36|159>>
    <associate|eq:curved.interpolation.ue|<tuple|8.5.1.1|170>>
    <associate|eq:curved.lagrange.basis|<tuple|8.6|152>>
    <associate|eq:curved.lo.numflux|<tuple|8.46|162>>
    <associate|eq:curved.lohner.ind|<tuple|8.71|175>>
    <associate|eq:curved.low.order.cell.avg.update.curved|<tuple|8.49|163>>
    <associate|eq:curved.low.update.2d|<tuple|8.51|167>>
    <associate|eq:curved.lower.order.curved|<tuple|8.45|162>>
    <associate|eq:curved.lower.order.flux.curved|<tuple|8.44|162>>
    <associate|eq:curved.lw.update|<tuple|8.23|156>>
    <associate|eq:curved.lwfr.update.curvilinear|<tuple|8.28|157>>
    <associate|eq:curved.metric.identity.contravariant|<tuple|8.14|153>>
    <associate|eq:curved.metric.identity.contravariant.inter|<tuple|8.35|159>>
    <associate|eq:curved.metric.identity.contravariant.poly|<tuple|8.37|159>>
    <associate|eq:curved.partition|<tuple|8.3|152>>
    <associate|eq:curved.pro4.with.lagrange|<tuple|8.63|170>>
    <associate|eq:curved.proP.defn|<tuple|8.59|168>>
    <associate|eq:curved.product.of.operators|<tuple|8.60|168>>
    <associate|eq:curved.proj.mortar.int.id|<tuple|8.68|173>>
    <associate|eq:curved.projection.integral.equation|<tuple|8.69|173>>
    <associate|eq:curved.reference.map|<tuple|8.4|152>>
    <associate|eq:curved.rusanov.flux|<tuple|8.19|155>>
    <associate|eq:curved.rusanov.flux.lw|<tuple|8.26|156>>
    <associate|eq:curved.semi.discrete.fr|<tuple|8.21|155>>
    <associate|eq:curved.subint.op|<tuple|8.58|168>>
    <associate|eq:curved.submap|<tuple|8.56|168>>
    <associate|eq:curved.submap.inverse|<tuple|8.57|168>>
    <associate|eq:curved.time.averaged.flux|<tuple|8.24|156>>
    <associate|eq:curved.time.avg.is.physical.flux|<tuple|8.39|160>>
    <associate|eq:curved.transformed.conservation.law|<tuple|8.12|153>>
    <associate|eq:curved.uXidefn|<tuple|8.65|172>>
    <associate|eq:curved.ueues.defn|<tuple|8.61|169>>
    <associate|eq:curved.uloc.high|<tuple|8.75|177>>
    <associate|eq:curved.unp1.low|<tuple|8.77|178>>
    <associate|eq:curved.ut.defn|<tuple|8.33|158>>
    <associate|eq:curved.utt.defn|<tuple|8.34|158>>
    <associate|eq:curved.well.constructed|<tuple|8.38|159>>
    <associate|eq:curved.xis.notation|<tuple|8.16|154>>
    <associate|eq:ftilde.free.stream|<tuple|8.40|160>>
    <associate|eq:rusanov.lambda|<tuple|8.20|155>>
    <associate|eq:semi.integral.form|<tuple|8.31|157>>
    <associate|fig:curved.blunt|<tuple|8.12|188>>
    <associate|fig:curved.curved.subcells|<tuple|8.2|161>>
    <associate|fig:curved.dmr|<tuple|8.7|183>>
    <associate|fig:curved.forward.step|<tuple|8.8|184>>
    <associate|fig:curved.free.stream|<tuple|8.9|185>>
    <associate|fig:curved.isentropic|<tuple|8.10|186>>
    <associate|fig:curved.kh|<tuple|8.6|182>>
    <associate|fig:curved.m2000|<tuple|8.5|181>>
    <associate|fig:curved.mortar|<tuple|8.4|171>>
    <associate|fig:curved.naca|<tuple|8.14|189>>
    <associate|fig:curved.naca.mesh|<tuple|8.13|189>>
    <associate|fig:curved.ref.map|<tuple|8.1|154>>
    <associate|fig:curved.refine.coarsen|<tuple|8.3|169>>
    <associate|fig:curved.supersonic.cylinder|<tuple|8.11|187>>
    <associate|footnote-8.1|<tuple|8.1|158>>
    <associate|footnote-8.2|<tuple|8.2|169>>
    <associate|footnr-8.1|<tuple|8.1|158>>
    <associate|footnr-8.2|<tuple|8.2|169>>
    <associate|rmk:amr.metric.terms|<tuple|8.7|174>>
    <associate|sec:curved.alwp|<tuple|8.3.3|158>>
    <associate|sec:curved.amr|<tuple|8.5|167>>
    <associate|sec:curved.amr.indicator|<tuple|8.5.3|175>>
    <associate|sec:curved.blunt|<tuple|8.7.2.4|188>>
    <associate|sec:curved.conclusions|<tuple|8.8|191>>
    <associate|sec:curved.cons.lw|<tuple|8.3|154>>
    <associate|sec:curved.curvilinear.coords|<tuple|8.2|151>>
    <associate|sec:curved.cylinder|<tuple|8.7.2.3|186>>
    <associate|sec:curved.dmr|<tuple|8.7.1.3|182>>
    <associate|sec:curved.el2mortar|<tuple|8.5.2.2|172>>
    <associate|sec:curved.error.lw|<tuple|8.6.2|177>>
    <associate|sec:curved.flux.correction|<tuple|8.4.3|165>>
    <associate|sec:curved.flux.correction.curved|<tuple|8.4.3.2|166>>
    <associate|sec:curved.flux.limiter.1d|<tuple|8.4.3.1|165>>
    <associate|sec:curved.forward.step|<tuple|8.7.1.4|183>>
    <associate|sec:curved.fr|<tuple|8.3.1|154>>
    <associate|sec:curved.free.stream.lwfr|<tuple|8.3.4|158>>
    <associate|sec:curved.handling.mortars|<tuple|8.5.2|171>>
    <associate|sec:curved.isentropic|<tuple|8.7.2.2|185>>
    <associate|sec:curved.lwfr.curved|<tuple|8.3.2|156>>
    <associate|sec:curved.naca|<tuple|8.7.2.5|188>>
    <associate|sec:curved.numerical.results|<tuple|8.7|179>>
    <associate|sec:curved.proj.elem|<tuple|8.5.1.2|170>>
    <associate|sec:curved.proj.face|<tuple|8.5.2.3|173>>
    <associate|sec:curved.rk.error.section|<tuple|8.6.1|176>>
    <associate|sec:curved.shock.capturing|<tuple|8.4|161>>
    <associate|sec:curved.smooth.ind|<tuple|8.4.2|164>>
    <associate|sec:curved.soln.transfer|<tuple|8.5.1|169>>
    <associate|sec:curved.time.stepping|<tuple|8.6|176>>
    <associate|sec:low.order.curvilinear|<tuple|8.4.1|161>>
    <associate|tab:cfl.error|<tuple|8.1|190>>
    <associate|thm:curved.lwfr.admissibility|<tuple|8.6|165>>
  </collection>
</references>
