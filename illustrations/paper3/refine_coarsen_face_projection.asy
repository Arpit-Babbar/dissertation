...
pen arrow_pen = purple+linewidth(0.75);
...
label(scale(u_scal) * "$F_\Gamma$",(lsqr_end - 0.08,0.0));
...
label(scale(u_scal) * "$F_{\Xi_1}$", (mortar_x + 0.1, 0.75 * mortar2_tip.y + 0.25 * mortar2_base.y), mortar1_flux_pen);
label(scale(u_scal) * "$F_{\Xi_2}$", (mortar_x + 0.1, 0.75 * mortar1_base.y + 0.25 * mortar1_tip.y), mortar2_flux_pen);

draw(reverse((lsqr_end + 0.05, lsqr_ycenter - 0.01) -- (mortar_x - 0.05, mortar1_ycenter - 0.01)), arrow_pen, Arrow);
draw(reverse((lsqr_end + 0.05, lsqr_ycenter + 0.01) -- (mortar_x - 0.05, mortar2_ycenter + 0.01)), arrow_pen, Arrow);

real rsqr_1_start_x = rssqr1_strt;

draw(reverse((rsqr_1_start_x - 0.05, mortar1_ycenter)--(mortar_x + 0.05,mortar1_ycenter)), arrow_pen, Arrow);
draw(reverse((rsqr_1_start_x - 0.05, mortar2_ycenter)--(mortar_x + 0.05,mortar2_ycenter)), arrow_pen, Arrow);
